            ...
            <div class="analysis-card">
              <div class="card-header">
                ...
                <div
                  :class="[
                    'badge',
                    hasAntiVM ? 'badge-warning' : 'badge-success',
                  ]"
                >
              ...
              <div class="card-content">
                <div v-if="antiVMTechniques.length > 0">
                  <div
                    v-for="(technique, index) in antiVMTechniques"
                    :key="index"
                    class="metric-item"
                  >
                    {{ technique.name }}
            ...
            <div class="analysis-card">
              <div class="card-header">
                ...
                <div
                  :class="[
                    'badge',
                    hasAntiDebug ? 'badge-warning' : 'badge-success',
                  ]"
                >
              ...
              <div class="card-content">
                <div v-if="antiDebugTechniques.length > 0">
                  <div
                    v-for="(technique, index) in antiDebugTechniques"
                    :key="index"
                    class="metric-item"
                  >
                    {{ technique.name }}
            ...
            <div class="analysis-card">
              <div class="card-header">
                ...
                <div
                  :class="[
                    'badge',
                    hasObfuscation ? 'badge-warning' : 'badge-success',
                  ]"
                >
              ...
              <div class="card-content">
                <div v-if="obfuscationTechniques.length > 0">
                  <div
                    v-for="(technique, index) in obfuscationTechniques"
                    :key="index"
                    class="metric-item"
                  >
                    {{ technique.name }}
            ...
            <div class="analysis-card">
              ...
              <div class="card-content">
                <div v-if="compilerFindings.length > 0">
                  <div
                    v-for="(finding, index) in compilerFindings"
                    :key="index"
                    class="metric-item"
                  >
                    {{ finding.name }}
...
export default {
  ...
  computed: {
    ...
    antiVMTechniques() {
      return (
        this.moduleData?.results?.filter((f) => f.rule_id === "anti_vm") || []
      );
    },
    hasAntiVM() {
    ...
    antiDebugTechniques() {
      return (
        this.moduleData?.results?.filter((f) => f.rule_id === "anti_debug") ||
        []
      );
    },
    hasAntiDebug() {
    ...
    obfuscationTechniques() {
      return (
        this.moduleData?.results?.filter(
          (f) =>
            f.rule_id === "obfuscator" ||
            f.rule_id === "packer" ||
            f.rule_id === "protector",
        ) || []
      );
    ...
    compilerFindings() {
      return (
        this.moduleData?.results?.filter((f) => f.rule_id === "compiler") || []
      );
    },
  },
};
