        ...
        <div class="analysis-grid">
          <div class="analysis-card">
            ...
            <div class="card-content">
              <div v-if="dangerousPermissions.length" class="permission-list">
                <div
                  v-for="perm in dangerousPermissions"
                  :key="perm"
          ...
          <div class="analysis-card">
            <div class="card-header">
              ...
              <div class="badge badge-primary">
                {{ customPermissions.length }} Found
              </div>
            </div>
            <div class="card-content">
          ...
          <div class="analysis-card">
            <div class="card-header">
              ...
              <div class="badge badge-info">
                {{ requestedPermissions.length }} Found
              </div>
            </div>
            <div class="card-content">
    ...
    getPermissionDescription(permission) {
      const descriptions = {
        "android.permission.READ_CALENDAR":
          "Allows reading calendar events and details",
        "android.permission.WRITE_CALENDAR":
          "Allows adding/modifying calendar events",
        "android.permission.CAMERA": "Allows access to the camera device",
        "android.permission.READ_CONTACTS":
          "Allows reading user's contacts data",
        "android.permission.WRITE_CONTACTS":
          "Allows modifying user's contacts data",
        "android.permission.GET_ACCOUNTS":
          "Allows access to the list of accounts",
        ...
        "android.permission.ANSWER_PHONE_CALLS":
          "Allows answering incoming calls",
        ...
        "android.permission.REQUEST_INSTALL_PACKAGES":
          "Allows requesting package installation",
      };
