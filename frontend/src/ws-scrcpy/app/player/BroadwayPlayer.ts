...
import YUVCanvas from '@/ws-scrcpy/vendor/h264-live-player/YUVCanvas';
import YUVWebGLCanvas from '@/ws-scrcpy/vendor/h264-live-player/YUVWebGLCanvas';
import Avc from '@/ws-scrcpy/vendor/Broadway/Decoder';
import VideoSettings from '../VideoSettings';
import Canvas from '@/ws-scrcpy/vendor/h264-live-player/Canvas';
