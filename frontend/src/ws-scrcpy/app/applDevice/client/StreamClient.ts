...
export abstract class StreamClient<T extends ParamsStream> extends BaseClient<T, StreamClientEvents> {
  ...
  protected constructor(params: T) {
    super(params);
    console.log('[StreamClient] Constructor called with params:', params);
    ...
    console.log('[StreamClient] Constructor completed');
  }
  ...
  protected startStream(inputPlayer?: BasePlayer): void {
    console.log('[StreamClient] startStream called with params:', this.params);
