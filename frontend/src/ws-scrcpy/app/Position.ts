...
export default class Position {
  ...
  public rotate(rotation: number): Position {
    switch (rotation) {
      case 1:
        return new Position(new Point(this.screenSize.height - this.point.y, this.point.x), this.screenSize.rotate());
      case 2:
        return new Position(
      ...
      case 3:
        return new Position(new Point(this.point.y, this.screenSize.width - this.point.x), this.screenSize.rotate());
      default:
        return this;
    }
  }
