            ...
            <div class="setting-row">
              <div class="setting-type">
                <label>
                  <input 
                    type="radio" 
                    v-model="formData.apkActionType" 
                    value="" 
                    @change="updateApkSettings" 
                  /> None
                </label>
                <label>
                  <input 
            ...
            <div class="setting-row">
              <div class="setting-type">
                <label>
                  <input 
                    type="radio" 
                    v-model="formData.ipaActionType" 
                    value="" 
                    @change="updateIpaSettings"
                  /> None
                </label>
                <label>
                  <input 
            ...
            <div class="setting-row">
              <div class="setting-type">
                <label>
                  <input 
                    type="radio" 
                    v-model="formData.zipActionType" 
                    value="" 
                    @change="updateZipSettings"
                  /> None
                </label>
                <label>
                  <input 
